...
# Adapted from https://github.com/koreader/KoboUSBMS/blob/master/scripts/end-usbms.sh
...
# c.f., https://github.com/Skilvingr/kaesar/blob/master/scripts/usb-disable.sh
