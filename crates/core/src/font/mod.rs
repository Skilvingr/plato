...
unsafe extern "C" {
    ...
    pub static _binary_resources_fonts_noto_NotoSerifTamil_Regular_otf_start:
        [libc::c_uchar; 33752];
    pub static _binary_resources_fonts_noto_NotoSerifTangut_Regular_otf_start:
        [libc::c_uchar; 2001224];
...
impl Fonts {
    pub fn load() -> Result<Fonts, Error> {
        ...
        let mut fonts = Fonts {
            ...
            serif: FontFamily {
                regular: opener.open("fonts/noto/NotoSerif-Regular.ttf")?,
                italic: opener.open("fonts/noto/NotoSerif-Italic.ttf")?,
                bold: opener.open("fonts/noto/NotoSerif-Bold.ttf")?,
                bold_italic: opener.open("fonts/noto/NotoSerif-BoldItalic.ttf")?,
            },
...
impl Font {
    ...
    pub fn plan<S: AsRef<str>>(
        ...
        unsafe {
            ...
            hb_buffer_set_direction(buf, HbDirection::HB_DIRECTION_LTR);
            hb_buffer_guess_segment_properties(buf);
